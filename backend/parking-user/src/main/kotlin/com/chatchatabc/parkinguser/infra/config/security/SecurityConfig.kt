package com.chatchatabc.parkinguser.infra.config.security

import com.chatchatabc.parkinguser.infra.config.security.filter.JwtRequestFilter
    ...
    fun securityFilterChain(http: HttpSecurity): SecurityFilterChain {
        return http
            ...
            .authorizeHttpRequests {
                ...
                // All routes must have user role
